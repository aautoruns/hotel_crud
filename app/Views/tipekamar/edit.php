...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"> <i class="fas fa-fw fa-bed"></i> Form Edit Data Tipe Kamar</h6>
    </div>
    <div class="card-body">
        ...
        <form action="/tipekamar/update/<?= $tipekamar['idtipekamar']; ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= ($validation->hasError('idtipekamar')) ? 'is-invalid' : ''; ?>" id="idtipekamar" name="idtipekamar" autofocus value="<?= $tipekamar['idtipekamar']; ?>">
